package com.espavila.skyteam.service;
...
import com.espavila.skyteam.configuration.Configuration;
import com.espavila.skyteam.entity.Player;
...
public class Box2DService {
    ...
    private static final float WIDTH = SkyTeam.WIDTH / 10f; // Width of Box2D world.
    private static final float HEIGHT = SkyTeam.HEIGHT / 10f; // Height of Box2D world.
